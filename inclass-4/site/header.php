    ...
    <header>
        ...
        <div class="inner-header">
            ...
            <nav class="mobile-nav" id="mobile-nav" aria-label="Mobile version menu">
                ...
                <div class='cse-search-box global-search search-form'>
                    <gcse:searchbox-only enableAutoComplete='true' resultsUrl='/search/?cx=002179760531728369470%3Aecn4eupdfpm&cof=FORID%3A11&ie=UTF-8&q='></gcse:searchbox-only>
                </div>
                    ...
                    <li>
                        <div class="menu-main-menu-container">
                            <ul id="menu-main-menu" class="main-nav-list">
                                <li id="menu-item-286" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-286"><a href="/future-students/">Future Students</a></li>
                                ...
                                <li><a class="toggleSearch" title="Open the site search input box." href="#"><i class="icon-search"><span class="hiddenToggleText">Search</span></i></a></li>
                            </ul>
                        </div>
                    </li>
            ...
            <div id="searchForm">
                ...
                <div class='cse-search-box global-search search-form'>
                    <gcse:searchbox-only enableAutoComplete='true' resultsUrl='/search/?cx=002179760531728369470%3Aecn4eupdfpm&cof=FORID%3A11&ie=UTF-8&q='></gcse:searchbox-only>
                </div> <label for="close" class="visuallyhidden">Close search box</label>
            ...
            <div class="actions-container">
                <nav class="campus-nav" aria-label="Campus menu">
                    <ul id="menu-locations" class="menu">
                        <li id="menu-item-305" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home  page-item-5 menu-item-305 <?php if ($current_page == 'index') {
                                                                                                                                                                echo 'current-menu-item';
                                                                                                                                                            } ?>"><a title="Algonquin College Home &#8211; Ottawa Campus" href="/">Index</a></li>
                        ...
                        <li id="menu-item-277" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-277 <?php if ($current_page == 'products') {
                                                                                                                                echo 'current-menu-item';
        ...
        <div class="global-nav">
            <nav aria-label="Main menu">
                <div class="menu-main-menu-container">
                    <ul id="menu-main-menu-1" class="main-nav-list">
                        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-286"><a href="/future-students/">Future Students</a></li>
